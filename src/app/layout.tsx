...
export const metadata: Metadata = {
  ...
  description: 'Applyd is the free AI-powered internship tracker for college students. Track applications, get AI interview prep, generate follow-up emails, and receive personalized recruiting coaching — automatically. Built by students for students.',
  ...
  openGraph: {
    ...
    description: 'Applyd is the free AI-powered internship tracker for college students. Track applications, get AI interview prep, generate follow-up emails, and receive personalized recruiting coaching — automatically.',
  ...
  twitter: {
    ...
    creator: '@useapplyd',
    title: 'Applyd — AI-Powered Internship Tracker for Students',
    description: 'Track applications and get AI interview prep, follow-up emails, and personalized recruiting coaching — automatically. Free for students.',
    images: ['/og-image.png'],
  },
  robots: {
    index: true,
