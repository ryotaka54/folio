      ...
      <main className="max-w-[860px] mx-auto px-6 py-16">
        ...
        {installed ? (
          <div className="text-center py-20">
            <div className="w-16 h-16 rounded-2xl flex items-center justify-center mx-auto mb-6" style={{ background: 'var(--success-bg)', border: '1px solid var(--success-border)' }}>
              <CheckIcon />
            </div>
          ...
          <>
            ...
            <div className="text-center mb-14">
              ...
              {deferredPrompt ? (
                <button
                  ...
                  style={{ background: 'var(--accent-blue)', boxShadow: '0 4px 20px color-mix(in oklch, var(--accent-blue) 35%, transparent)' }}
            ...
            {browser !== 'chrome' && browser !== 'edge' && (
              <div
                ...
                style={{ background: 'var(--warn-bg)', borderColor: 'color-mix(in oklch, var(--amber-warning) 20%, transparent)' }}
              >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                {BENEFITS.map(b => (
                  <div
                    ...
                    style={{ background: 'var(--card-bg)', borderColor: 'var(--border-gray)' }}
                  >
                    <div className="w-5 h-5 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5" style={{ background: 'var(--success-bg)' }}>
